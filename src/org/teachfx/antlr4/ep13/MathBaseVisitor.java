...
public class MathBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements MathVisitor<T> {
     ...
     */
    @Override
    public T visitCompileUnit(MathParser.CompileUnitContext ctx) {
     ...
     */
    @Override
    public T visitVarExpr(MathParser.VarExprContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitUnaryExpr(MathParser.UnaryExprContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitAssignExpr(MathParser.AssignExprContext ctx) {
        return visitChildren(ctx);
    }
}