...
public class MathExprBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements MathExprVisitor<T> {
     ...
     */
    @Override
    public T visitCompileUnit(MathExprParser.CompileUnitContext ctx) {
     ...
     */
    @Override
    public T visitVarDelaration(MathExprParser.VarDelarationContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitExpr(MathExprParser.ExprContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitType(MathExprParser.TypeContext ctx) {
        return visitChildren(ctx);
    }
}