...
**规范状态**: 批准 (Approved)
**整合说明**: 本规范整合了《EP18R_核心设计文档.md》和《OPENSPECKIT_SPECIFICATION.md》的核心内容，形成统一的架构设计规范。
...
**维护者**: Claude Code
**状态**: 正式发布（整合版）
**整合说明**: 本规范整合了原《EP18R_核心设计文档.md》和《OPENSPECKIT_SPECIFICATION.md》的核心内容，形成统一的架构设计规范。