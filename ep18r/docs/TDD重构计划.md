...
|--------|------|------|--------|--------|----------|------|
| TASK-001 | 统一寄存器命名和用途定义 | 未执行 | 高 | | 2025-12-20 | 更新VM设计文档中的寄存器约定 |
| TASK-002 | 实现标准栈帧布局（按ABI规范） | 未执行 | 高 | | 2025-12-25 | 替换当前简化栈帧结构 |
...
| TASK-007 | 统一调用约定（调用栈+LR双重机制） | 未执行 | 高 | | 2025-12-21 | 确保与ABI调用约定一致 |
| TASK-008 | 更新VM设计文档与ABI设计文档一致 | 未执行 | 中 | | 2025-12-19 | 合并冗余内容，保持单一来源 |
