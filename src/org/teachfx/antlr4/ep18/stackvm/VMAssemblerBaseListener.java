...
public class VMAssemblerBaseListener implements VMAssemblerListener {
     ...
     */
    @Override
    public void enterProgram(VMAssemblerParser.ProgramContext ctx) {
    }
     ...
     */
    @Override
    public void enterGlobals(VMAssemblerParser.GlobalsContext ctx) {
    }
     ...
     */
    @Override
    public void enterFunctionDeclaration(VMAssemblerParser.FunctionDeclarationContext ctx) {
    }
     ...
     */
    @Override
    public void enterOperand(VMAssemblerParser.OperandContext ctx) {
    }
     ...
     */
    @Override
    public void exitOperand(VMAssemblerParser.OperandContext ctx) {
    }
     ...
     */
    @Override
    public void enterLabel(VMAssemblerParser.LabelContext ctx) {
    }
