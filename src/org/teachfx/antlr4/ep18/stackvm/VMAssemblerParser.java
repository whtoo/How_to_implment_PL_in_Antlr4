...
public class VMAssemblerParser extends Parser {
    ...
    public static class ProgramContext extends ParserRuleContext {
        ...
        public List<TerminalNode> NEWLINE() {
            return getTokens(VMAssemblerParser.NEWLINE);
        }
    ...
    public static class GlobalsContext extends ParserRuleContext {
        ...
        public TerminalNode INT() {
            return getToken(VMAssemblerParser.INT, 0);
        }
    ...
    public static class FunctionDeclarationContext extends ParserRuleContext {
        ...
        public TerminalNode NEWLINE() {
            return getToken(VMAssemblerParser.NEWLINE, 0);
        }

        public TerminalNode ID() {
            return getToken(VMAssemblerParser.ID, 0);
        }

        public List<TerminalNode> INT() {
            return getTokens(VMAssemblerParser.INT);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof VMAssemblerListener)
                ((VMAssemblerListener) listener).enterFunctionDeclaration(this);
        }
    ...
    public static class OperandContext extends ParserRuleContext {
        ...
        public TerminalNode REG() {
            return getToken(VMAssemblerParser.REG, 0);
        }

        public TerminalNode FUNC() {
            return getToken(VMAssemblerParser.FUNC, 0);
        }
        ...
        public TerminalNode CHAR() {
            return getToken(VMAssemblerParser.CHAR, 0);
        }

        public TerminalNode STRING() {
            return getToken(VMAssemblerParser.STRING, 0);
        }

        public TerminalNode FLOAT() {
            return getToken(VMAssemblerParser.FLOAT, 0);
        }
