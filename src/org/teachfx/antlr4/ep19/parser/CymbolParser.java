...
public class CymbolParser extends Parser {
    ...
    public static class StructMemeberContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_structMemeber;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CymbolVisitor)
                return ((CymbolVisitor<? extends T>) visitor).visitStructMemeber(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class StatStructDeclContext extends StatetmentContext {
        public StatStructDeclContext(StatetmentContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CymbolVisitor)
                return ((CymbolVisitor<? extends T>) visitor).visitStatStructDecl(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ExprNewContext extends ExprContext {
        public ExprNewContext(ExprContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class ExprStructFieldAccessContext extends ExprContext {
        ...
        public ExprStructFieldAccessContext(ExprContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CymbolVisitor)
                return ((CymbolVisitor<? extends T>) visitor).visitExprStructFieldAccess(this);
            else return visitor.visitChildren(this);
        }
    }
